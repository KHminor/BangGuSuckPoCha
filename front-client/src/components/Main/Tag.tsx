...
function Tag(): JSX.Element {
  ...
  return (
    <div className="grid w-full min-w-[75rem] h-full " style={{gridTemplateColumns:'7fr 4fr', backgroundColor: "rgb(25, 25, 25)"}}>
      <div className="grid items-center w-full text-white " style={{gridTemplateColumns:'0.6fr 1fr 1fr 1fr 1fr 1fr'}}>
        ...
        <div className="flex justify-center items-center relative font-normal ml-2 border-2 rounded-full h-1/3">연령 &nbsp;&nbsp;&nbsp;&nbsp;⮟</div>
