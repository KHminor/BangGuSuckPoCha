    ...
    >
      {isOver ? (
        ...
        >
          ...
          {/* 내용물 */}
          <div className="grid h-full w-full bg-black" style={{ borderRadius: "0px 0px 16px 16px", gridTemplateRows:'1fr 1fr 1fr 0.2fr' }}>
            <div className="grid" style={{gridTemplateColumns: '2fr 1fr 1fr'}}>
              {/* 테마종류 */}
              <div className="flex justify-center items-center">
                <div className="flex justify-center items-center w-[80%] h-[40%] rounded-full text-base font-medium" style={{backgroundColor: themeTypeColor}}>
                  {themeType}
                </div>
              </div>
              <div></div>
            ...
            <div className="w-[17rem] max-w-[17rem] flex flex-col justify-between items-start pl-[1rem] overflow-hidden whitespace-nowrap text-ellipsis">
              <div className="flex justify-start items-center w-[16rem] max-w-[176em] overflow-hidden whitespace-nowrap text-ellipsis text-base font-medium">{ssulTitle}</div>
              <div className="flex justify-start items-center w-[16rem] max-w-[176em] overflow-hidden whitespace-nowrap text-ellipsis text-base font-medium">{TagList}</div>
            </div>
            {/* 술 체크 및 인원수 체크 */}
            <div className="grid" style={{gridTemplateColumns: '1fr 1fr'}}>
              ...
              <div className="flex justify-center items-end">
                <img className="w-[1.7rem] h-[1.7rem]" src={require('../../assets/mainIcon/maleIcon.png')} alt="" /><div className="pr-2">&nbsp;{maleCount}</div>
                <img className="w-[1.7rem] h-[1.7rem]" src={require('../../assets/mainIcon/femaleIcon.png')} alt="" /><div>&nbsp;{femaleCount}</div>
              </div>
            </div>
            <div className=""></div>
          </div>
